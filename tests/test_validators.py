...
def test_luhn_credit_card_validation():
    ...
    # Use standard Visa number to verify Luhn positive match
    ...
    # Mutate last digit to trigger Luhn checksum failure
...
def test_mod97_iban_validation():
    ...
    # Use valid German IBAN for mod-97 check
    ...
    # Mutate check digits to verify rejection
...
def test_proximity_keyword_confidence_boost():
    ...
    # Context window contains 'security', boosting confidence to 90%
    ...
    # Missing context keywords drops confidence to default (25%)
